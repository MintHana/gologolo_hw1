...
import AppsterModel from './AppsterModel.js';
...
export default class AppsterController {
    ...
    registerAppsterEventHandlers() {
        ...
        //text input enter and cancel buttons
        this.registerEventHandler(AppsterGUIId.APPSTER_TEXT_INPUT_MODAL_ENTER_BUTTON, AppsterHTML.CLICK, this[AppsterCallback.APPSTER_PROCESS_ISVALID]);
        this.registerEventHandler(AppsterGUIId.APPSTER_TEXT_INPUT_MODAL_CANCEL_BUTTON, AppsterHTML.CLICK, this[AppsterCallback.APPSTER_PROCESS_CANCEL_CREATION]);

        //char modal ok button
        this.registerEventHandler(AppsterGUIId.APPSTER_CHAR_MODAL_OK_BUTTON, AppsterHTML.CLICK, this[AppsterCallback.APPSTER_PROCESS_CONFIRM]);

        //confirm modal ok button
        this.registerEventHandler(AppsterGUIId.APPSTER_CONFIRM_MODAL_OK_BUTTON, AppsterHTML.CLICK, this[AppsterCallback.APPSTER_PROCESS_CONFIRM]);
    ...
    */
    ...
    /*
    * This function is used to check if the new Work name is valid.
    */
    processIsValid = (newName) => {
        console.log("processIsValid");

        newName = document.getElementById(AppsterGUIId.APPSTER_TEXT_INPUT_MODAL_TEXTFIELD).value
        this.model.checkValidity(newName);
    }

    processConfirm = () => {
        console.log("confirm button");
        this.model.okConfirm();
    }

    /*
    * This function is used when canceling creation of new Logo
    */
   processCancelNewWork = () => {
       console.log("processCancelNewWork");

       this.model.cancelCreate();
   }
    ...
    processConfirmDeleteWork = () => {
        ...
        this.model.removeWork(this.model.getCurrentWork());
