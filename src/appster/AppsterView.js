...
export default class AppsterView {
    ...
    loadRoot(appData) {
        ...
        if (!appsterRootDiv) {
            ...
            let appsterCharModal = this.buildAppsterCharModal();
            ...
            appsterRootDiv.appendChild(appsterCharModal);

            var arr = this.extrabuilds();

            for(let i = 0; i < arr.length; i++)
            {
                let temp = arr[i];

                appsterRootDiv.appendChild(temp);
            }
    ...
    buildAppsterCharModal() {
        let charModal = this.buildElement( AppsterHTML.DIV, 
                                            AppsterGUIId.APPSTER_CHAR_MODAL,
                                            [AppsterGUIClass.APPSTER_MODAL],
                                            [],
                                            null,
                                            AppsterGUIClass.MODAL_ANIMATION_LEFT);
        let charFrame = this.buildElement( AppsterHTML.DIV, 
                                            AppsterGUIId.APPSTER_CONFIRM_MODAL_FRAME,
                                            [AppsterGUIClass.APPSTER_MODAL_FRAME]);
        let header = this.buildElement( AppsterHTML.HEADER, 
                                        AppsterGUIId.APPSTER_CONFIRM_MODAL_HEADER,
        ...
        let strong = this.buildElement(     AppsterHTML.STRONG, 
                                            ...
                                            [],
                                            [],
                                            AppsterText.APPSTER_CHAR_MODAL_PROMPT_TEXT);
        let okButton = this.buildElement(   AppsterHTML.BUTTON, 
                                            AppsterGUIId.APPSTER_CHAR_MODAL_OK_BUTTON,
                                            [AppsterGUIClass.APPSTER_MODAL_BUTTON],
                                            [],
                                            AppsterText.APPSTER_CONFIRM_MODAL_OK_BUTTON_TEXT);
        let footer = this.buildElement(     AppsterHTML.FOOTER, 
                                            ...
                                            [AppsterGUIClass.APPSTER_MODAL_FOOTER],
                                            [],
                                            AppsterText.APPSTER_CHAR_MODAL_FOOTER_TEXT);
        p.appendChild(strong);
        section.appendChild(p);
        charFrame.appendChild(header);
        charFrame.appendChild(section);
        section.appendChild(okButton);
        charFrame.appendChild(footer);
        charModal.appendChild(charFrame);
        return charModal;
    }
...
//        this.controller.setupCallback(newA, AppsterHTML.ONCLICK, AppsterCallback.APPSTER_PROCESS_EDIT_WORK, callbackArguments);
   ...
   /*
   *  This method was created to display text input modal.
   */
   showTextInput()  {
   ...
   /*
   * This method was created to hide text input modal.
   */
   hideTextInput()  {
       let input = document.getElementById(AppsterGUIId.APPSTER_TEXT_INPUT_MODAL);
   ...
   /*
   *    This method was created for show and hide char modal
   */
    showChar() {
        let input = document.getElementById(AppsterGUIId.APPSTER_CHAR_MODAL);
   ...
   /*
   *    This method was created for show and hide confirm modal
   */
   showConfirm()    {
        let input = document.getElementById(AppsterGUIId.APPSTER_CONFIRM_MODAL);
