...
export const AppsterCallback = {
    ...
    APPSTER_PROCESS_ISVALID: "processIsValid",
    APPSTER_PROCESS_CANCEL_CREATION: "processCancelNewWork",
    APPSTER_PROCESS_CONFIRM: 'processConfirm'
};
...
export const AppsterGUIId = {
    ...
    APPSTER_CHAR_MODAL: 'appster_char_modal',
    APPSTER_CHAR_MODAL_FRAME: 'appster_char_modal_frame',
    APPSTER_CHAR_MODAL_Header: 'appster_char_modal_header',
    APPSTER_CHAR_MODAL_SECTION: 'appster_char_modal_section',
    APPSTER_CHAR_MODAL_OK_BUTTON: 'appster_char_modal_ok_button',
    APPSTER_CHAR_MODAL_FOOTER: 'appster_char_frame',
...
export const AppsterText = {
    ...
    APPSTER_CHAR_MODAL_PROMPT_TEXT: "appster_confirm_modal_prompt_char_text",
    APPSTER_CHAR_MODAL_FOOTER_TEXT: "appster_confirm_modal_footer_char_text",
